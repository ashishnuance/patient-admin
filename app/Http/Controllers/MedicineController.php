...
class MedicineController extends Controller
{
    ...
    public function store(Request $request){
        ...
        // $user->role()->attach($role->id);
         ...
         return redirect()->route('medicine-list')->with('success',__('locale.medicine_created_successfully'));
     }
     ...
     if ($medicine) {
         return redirect()->route('medicine-list')->with('success', __('locale.medicine_update_success'));
     } else {
         return redirect()->back()->with('error', 'Failed to update medicine')->withInput();
     }
